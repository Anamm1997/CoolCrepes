                        ...
                        <div className="col col-sm-8">
                            {
                                ...
                                this.state.selectedPanel === 'history' ?
                                    <PurchaseHistory userToken={this.props.userToken} purchases={this.state.purchases} updateHandler={this.updateParent}/> :
                                this.state.selectedPanel === 'comments' ?
                                    <Comments userToken={this.props.userToken} comments={this.state.comments} updateHandler={this.updateParent}/> :
