            ...
            <div className="nav-bg navbar navbar-expand-sm navbar-dark bg-dark">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ml-auto">  
                        ...
                        {this.props.userToken ?
                            (<li>
                                <NavLink to="/cart" className="cart pl-2 ">
                                    <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" className="bi bi-cart4 mt-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
